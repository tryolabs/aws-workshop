...
VPC가 생기면 중복성을 이유로 서로 다른 가용 영역에서 2 개의 개인 서브넷 (자동 확장 그룹이 웹 서버 인스턴스를 시작할 위치)을 만듭니다. 로드 밸런서에 필요한 동일한 가용성 영역에 2 개의 공용 서브넷을 설치합니다. VPC 와 subnets 에 대해 많은 것을 [here](https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_Subnets.html) 읽을 수 있습니다.
